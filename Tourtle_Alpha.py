...
#============================================================#
    ...
    'Westin St. Francis': { 
            GROUNDDESC: 'The luxury Westin St. Francis hotel',
...
# "look <item>" - display the description of an item on the ground or in your inventory
    ...
    # def cookie(fortune):
    #     while lookingAt == 'Makoto Hagiwara':
